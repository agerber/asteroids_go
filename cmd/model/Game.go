...
type CommandCenter struct {
	...
	Falcon      *Falcon // The player's ship
}

var commandCenter *CommandCenter

// CommandCenter returns a singleton instance of the game state.
func GetCommandCenter() *CommandCenter {
	if commandCenter == nil {
		commandCenter = &CommandCenter{
			...
			IsGameOver: false,
			IsPaused:   false,
			Falcon:     &Falcon{Shield: 100, NukeMeter: 0, IsMaxSpeedAttained: false},
		}
	}
